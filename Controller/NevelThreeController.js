  ...
  function girarCarta () {
    ...
    if ( jugada1 !== "" ) {
      ...
      if ( jugada1 === jugada2 && identificadorJ1 !== identificadorJ2 && cartas[parseInt(identificadorJ2)].seleccion != true && cartas[parseInt(identificadorJ1)].seleccion != true) {
        ...
        var self = this;
        setTimeout(function(){
          colorCambio(self.identificadorJ1, "#FF5733", "??")
          colorCambio(self.identificadorJ2, "#FF5733", "??")
          vaciar()
        },200); 
